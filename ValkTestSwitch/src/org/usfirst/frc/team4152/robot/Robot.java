...
public class Robot extends SampleRobot {
	...
	DigitalInput SwitchTest7 = new DigitalInput(7);
	DigitalInput SwitchTest8 = new DigitalInput(8);
	...
	public void operatorControl() {
        ...
        while (isOperatorControl() && isEnabled()) {
        	SmartDashboard.putInt("POV", (int)leftStick.getPOV());
    ...
    public void switchPOVTest()
    {
    	if((int)leftStick.getPOV() == 0 && SwitchTest7.get() == true)
    	{
    		shootMotor.set(0.4);
    		holdMotor.set(0.4);
    		intakeMotor.set(0.4);
    	}
    	else if((int)leftStick.getPOV() == 180 && SwitchTest8.get() == true)
    	{
    		shootMotor.set(-0.4);
    		holdMotor.set(-0.4);
    		intakeMotor.set(-0.4);
    	...
    	SmartDashboard.putBoolean("switch7", SwitchTest7.get());
    	SmartDashboard.putBoolean("switch8", SwitchTest8.get());
    }
    ...
    public void rightTrigButton()
    {
    	...
    	if(leftStick.getRawButton(leftBumper))
    	{
    		holdMotor.set(1);
    		shootMotor.set(-1);
