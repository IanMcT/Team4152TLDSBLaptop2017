...
//		System.out.println("loadingSystem called");
	...
	public boolean drive(double distance, double speed){
		//leftEncoder.reset();
		//gyro.reset();
		//Timer.delay(0.2);
		if(Math.abs(leftEncoder.getDistance())<distance && DougExitAuto.get() < 15)
		{
